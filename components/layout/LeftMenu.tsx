...
export default function LeftMenu({ isLoggedIn, role, isPromoter = false }: LeftMenuProps) {
        ...
        <>
            ...
            >
                ...
                <div className="flex items-center justify-between px-5 pt-5 pb-4 flex-shrink-0 border-b border-[#E8E8EE]">
                    <div>
                        <p className="font-heading text-2xl text-[#E63950] tracking-wider">HEXLURA<sup className="text-[0.45em] align-super tracking-normal">®</sup></p>
                        ...
                        <>
                            ...
                            {open['account'] && (
                                <div className="pt-2 space-y-0.5">
                                    ...
                                    <Link href="/notifications" onClick={close} className={linkClass('/notifications')}>Notifications</Link>
                                    <Link href="/support" onClick={close} className={linkClass('/support')}>Help &amp; Support</Link>
                                    {role === 'organiser' && (
                                        <Link href="/organiser" onClick={close} className={linkClass('/organiser')}>Organiser Portal</Link>
                                    )}
                                    {isPromoter && (
                                        <Link href="/promoter" onClick={close} className={linkClass('/promoter')}>Promoter Portal</Link>
                                    )}
                                    {role === 'admin' && (
