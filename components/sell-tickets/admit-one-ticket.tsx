...
function TicketCard({ name, presenter, event, venue, dates, stubText, watermark, width = REF, geometry = TICKET_GEOMETRY, layout = TICKET_LAYOUT, texture = TICKET_TEXTURE, gradient = TICKET_GRADIENT, className }: any) {
    ...
    return jsxs("div", {
        className: `relative select-none ${className ?? ""}`, style: { width, height, clipPath: `path('${ticketClipPath(width, height, geometry)}')` }, children: [
            ...
            jsxs("div", {
                className: "absolute inset-0", style: { color: layout.inkColor, fontFamily: layout.bodyFont || undefined, ...(layout.engraved ? { textShadow: "0 1px 0 rgba(0,0,0,0.4), 0 -1px 0 rgba(255,255,255,0.15)" } : {}) }, children: [
