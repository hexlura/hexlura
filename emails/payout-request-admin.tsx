...
interface PayoutRequestAdminProps {
    orgName: string
...
export default function PayoutRequestAdmin({
    orgName,
    organiserEmail,
    totalRequestedPence,
    payoutCount,
    appUrl,
}: PayoutRequestAdminProps) {
    const amount = formatGBP(totalRequestedPence)

    return (
        <BaseEmail previewText={`New payout request: ${orgName} — ${amount}`}>
            <Text style={headingStyle}>NEW PAYOUT REQUEST</Text>

            <Text style={bodyTextStyle}>
                An organiser has submitted a payout withdrawal request and is awaiting your review.
            </Text>
