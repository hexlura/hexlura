...
// ─── Organiser guide download ──────────────────────────────────────────────
// Download logic/state unchanged from the original implementation — only the
// visual wrapper now matches the reference's ghost-button style.
...
export default function SellTicketsClient({
  ...
  return (
    <div className="bg-[#f6f5f3] text-hexdark antialiased selection:bg-hexred selection:text-white overflow-x-hidden">
