  ...
  return (
    <div style={{ background: '#0A0A0F', minHeight: '100vh' }}>
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
        ...
        <h3 style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 18, color: '#F0F0F8', fontWeight: 600, marginTop: 24 }}>Essential Cookies (Always Active)</h3>
        <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 16, color: '#8888AA', lineHeight: 1.8, marginBottom: 16 }}>
          These cookies are required for the platform to function. You cannot opt out of these.
        </p>

        <h3 style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 18, color: '#F0F0F8', fontWeight: 600, marginTop: 24 }}>Authentication Cookies (Supabase Auth)</h3>
        <ul style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 16, color: '#8888AA', lineHeight: 1.8, marginBottom: 16, paddingLeft: 24 }}>
          <li style={{ marginBottom: 8 }}><strong style={{ color: '#F0F0F8' }}>Purpose</strong>: Keep you logged in during your session</li>
          <li style={{ marginBottom: 8 }}><strong style={{ color: '#F0F0F8' }}>Duration</strong>: Session / 7 days if &quot;remember me&quot; selected</li>
          <li style={{ marginBottom: 8 }}><strong style={{ color: '#F0F0F8' }}>Provider</strong>: Supabase</li>
        </ul>

        <h3 style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 18, color: '#F0F0F8', fontWeight: 600, marginTop: 24 }}>Payment Cookies (Stripe)</h3>
        <ul style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 16, color: '#8888AA', lineHeight: 1.8, marginBottom: 16, paddingLeft: 24 }}>
          <li style={{ marginBottom: 8 }}><strong style={{ color: '#F0F0F8' }}>Purpose</strong>: Secure payment processing and fraud prevention</li>
          <li style={{ marginBottom: 8 }}><strong style={{ color: '#F0F0F8' }}>Duration</strong>: Session</li>
          <li style={{ marginBottom: 8 }}><strong style={{ color: '#F0F0F8' }}>Provider</strong>: Stripe (<a href="https://stripe.com/privacy" style={{ color: '#E63950' }}>stripe.com/privacy</a>)</li>
        </ul>

        <h3 style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 18, color: '#F0F0F8', fontWeight: 600, marginTop: 24 }}>Analytics Cookies (Coming Soon)</h3>
        <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 16, color: '#8888AA', lineHeight: 1.8, marginBottom: 16 }}>
        ...
        <h3 style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 18, color: '#F0F0F8', fontWeight: 600, marginTop: 24 }}>Marketing Cookies</h3>
        <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 16, color: '#8888AA', lineHeight: 1.8, marginBottom: 16 }}>
