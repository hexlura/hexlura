...
const SOCIAL_PLATFORMS: Record<string, { label: string; color: string; icon: (props: { size?: number }) => React.ReactNode }> = {
    instagram: {
    ...
    tiktok: {
        ...
        icon: ({ size = 16 }) => (
            <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1 0-5.78c.27 0 .54.04.79.1v-3.5a6.37 6.37 0 0 0-.79-.05A6.34 6.34 0 0 0 3.15 15.3 6.34 6.34 0 0 0 9.49 21.64a6.34 6.34 0 0 0 6.34-6.34V8.78a8.21 8.21 0 0 0 3.76.92V6.69z" />
            </svg>
        ),
    },
    youtube: {
        ...
        icon: ({ size = 16 }) => (
            <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                <path d="M23.5 6.5a3.07 3.07 0 0 0-2.16-2.17C19.5 4 12 4 12 4s-7.5 0-9.34.33A3.07 3.07 0 0 0 .5 6.5 32.1 32.1 0 0 0 0 12a32.1 32.1 0 0 0 .5 5.5 3.07 3.07 0 0 0 2.16 2.17C4.5 20 12 20 12 20s7.5 0 9.34-.33a3.07 3.07 0 0 0 2.16-2.17A32.1 32.1 0 0 0 24 12a32.1 32.1 0 0 0-.5-5.5zM9.75 15.02V8.98L15.5 12l-5.75 3.02z" />
            </svg>
        ),
    },
    twitter: {
