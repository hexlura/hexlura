    ...
    <div style={{ background: '#0A0A0F', minHeight: '100vh' }}>
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
        ...
        <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 16, color: '#8888AA', lineHeight: 1.8, marginBottom: 16 }}>
          Hexlura is operated by <strong style={{ color: '#F0F0F8' }}>Hexlura Ltd (Company No. 17102803)</strong>, registered at 41 Junction Road, Northampton, England, NN2 7JA. We are registered with the Information Commissioner&apos;s Office (ICO). ICO Registration Number: [PENDING].
        </p>
        <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 16, color: '#8888AA', lineHeight: 1.8, marginBottom: 16 }}>
        ...
        <ul style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 16, color: '#8888AA', lineHeight: 1.8, marginBottom: 16, paddingLeft: 24 }}>
          <li style={{ marginBottom: 8 }}><strong style={{ color: '#F0F0F8' }}>Account data</strong>: name, email address, password (encrypted)</li>
          <li style={{ marginBottom: 8 }}><strong style={{ color: '#F0F0F8' }}>Booking data</strong>: ticket purchases, booking references, payment amounts</li>
          <li style={{ marginBottom: 8 }}><strong style={{ color: '#F0F0F8' }}>Payment data</strong>: processed securely by Stripe — we never store card details</li>
          <li style={{ marginBottom: 8 }}><strong style={{ color: '#F0F0F8' }}>Profile data</strong>: optional profile photo, organiser business details</li>
          <li style={{ marginBottom: 8 }}><strong style={{ color: '#F0F0F8' }}>Technical data</strong>: IP address, browser type, device information, cookies</li>
          <li style={{ marginBottom: 8 }}><strong style={{ color: '#F0F0F8' }}>Communications</strong>: emails you send to our support team</li>
        </ul>
        ...
        <ul style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 16, color: '#8888AA', lineHeight: 1.8, marginBottom: 16, paddingLeft: 24 }}>
          <li style={{ marginBottom: 8 }}><strong style={{ color: '#F0F0F8' }}>Contract performance</strong>: to process bookings and deliver tickets</li>
          <li style={{ marginBottom: 8 }}><strong style={{ color: '#F0F0F8' }}>Legal obligation</strong>: fraud prevention, financial record keeping</li>
          <li style={{ marginBottom: 8 }}><strong style={{ color: '#F0F0F8' }}>Legitimate interests</strong>: platform security, preventing abuse</li>
          <li style={{ marginBottom: 8 }}><strong style={{ color: '#F0F0F8' }}>Consent</strong>: marketing emails (you can unsubscribe at any time)</li>
        </ul>
        ...
        <ul style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 16, color: '#8888AA', lineHeight: 1.8, marginBottom: 16, paddingLeft: 24 }}>
          <li style={{ marginBottom: 8 }}><strong style={{ color: '#F0F0F8' }}>Stripe</strong>: payment processing (their privacy policy applies)</li>
          <li style={{ marginBottom: 8 }}><strong style={{ color: '#F0F0F8' }}>Supabase</strong>: secure database hosting (EU/US data processing agreement in place)</li>
          <li style={{ marginBottom: 8 }}><strong style={{ color: '#F0F0F8' }}>Resend</strong>: transactional email delivery</li>
          <li style={{ marginBottom: 8 }}><strong style={{ color: '#F0F0F8' }}>Vercel</strong>: website hosting</li>
        </ul>
        <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 16, color: '#8888AA', lineHeight: 1.8, marginBottom: 16 }}>
        ...
        <ul style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 16, color: '#8888AA', lineHeight: 1.8, marginBottom: 16, paddingLeft: 24 }}>
          <li style={{ marginBottom: 8 }}><strong style={{ color: '#F0F0F8' }}>Access</strong> your personal data</li>
          <li style={{ marginBottom: 8 }}><strong style={{ color: '#F0F0F8' }}>Rectify</strong> inaccurate data</li>
          <li style={{ marginBottom: 8 }}><strong style={{ color: '#F0F0F8' }}>Erase</strong> your data (&quot;right to be forgotten&quot;)</li>
          <li style={{ marginBottom: 8 }}><strong style={{ color: '#F0F0F8' }}>Restrict</strong> processing of your data</li>
          <li style={{ marginBottom: 8 }}><strong style={{ color: '#F0F0F8' }}>Data portability</strong> — receive your data in a machine-readable format</li>
          <li style={{ marginBottom: 8 }}><strong style={{ color: '#F0F0F8' }}>Object</strong> to processing based on legitimate interests</li>
          <li style={{ marginBottom: 8 }}><strong style={{ color: '#F0F0F8' }}>Withdraw consent</strong> at any time for consent-based processing</li>
        </ul>
        <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 16, color: '#8888AA', lineHeight: 1.8, marginBottom: 16 }}>
