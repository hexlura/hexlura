  ...
  return (
    <div style={{ background: '#0A0A0F', minHeight: '100vh' }}>
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px' }}>
        ...
        <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 16, color: '#8888AA', lineHeight: 1.8, marginBottom: 16 }}>
          <strong style={{ color: '#F0F0F8' }}>Email</strong>: <a href="mailto:support@hexlura.com" style={{ color: '#E63950' }}>support@hexlura.com</a><br />
          <strong style={{ color: '#F0F0F8' }}>Response time</strong>: Within 24 hours, Monday to Friday
        </p>

        <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 16, color: '#8888AA', lineHeight: 1.8, marginBottom: 16 }}>
          <strong style={{ color: '#F0F0F8' }}>Registered Office</strong>:<br />
          Hexlura Ltd<br />
          41 Junction Road<br />
          Northampton<br />
          England<br />
