...
function VerifyContent() {
    ...
    return (
        <section className="space-y-6 text-center">
            ...
            {message && (
                <p className="text-sm text-success bg-success/10 border border-success/20 rounded-lg px-4 py-2">{message}</p>
            )}
            ...
            <button
                ...
                disabled={cooldown > 0}
                className="w-full h-11 rounded-lg border border-border bg-card text-text font-medium text-sm hover:bg-card/80 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
