                ...
                <table className="hidden sm:table w-full text-sm">
                    <thead>
                        <tr className="border-b border-border">
                            ...
                            <th className="text-left text-xs text-muted pb-2 font-normal"></th>
                        </tr>
                    </thead>
                    <tbody>
                        {filtered.length === 0 && (
                                        ...
                                        {!a.checkedIn && (
                                            <button
                                                ...
                                                style={{
                                                    ...
                                                    color: '#fff',
                                                    border: 'none',
                                                    cursor: checkingIn.has(a.id) ? 'not-allowed' : 'pointer',
                                                    opacity: checkingIn.has(a.id) ? 0.6 : 1,
                                                    whiteSpace: 'nowrap',
                                                }}
                                            >
                                                {checkingIn.has(a.id) ? '...' : 'Check In'}
                                            </button>
                                        )}
                                    </td>
                                </tr>
